...
<body>
    ...
    <div class="all-content-wrapper">
		...
		<?php	
			...
			$s_id=(int)$_GET['s_id'];
			$sql = "select * from sy1_student where s_id=1";
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Update SY Student</a></li>
                            </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <form id="add-student" action="update_sy_student_code.php" method="post" class="add-student">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
															<!-- Left Section -->
															...
															<div class="form-group">
                                                                <select id="s_gender" name="s_gender" class="form-control" value="<?php echo $s_gender; ?>" >
																	<option value="$s_gender" selected="" disabled="">Select Gender</option>
