                                                ...
                                                <form id="add-student" action="add_fy_student_code.php" method="post" class="add-student">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <div class="form-group">
                                                                <input id="s_dob" name="s_dob" type="date" class="form-control" placeholder="Date of Birth">
                                                            </div>
															<div class="form-group">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
															<div class="form-group">
                                                                    <textarea id="s_address" name="s_address" placeholder="Address" style="height:80px;width:360px" ></textarea>
                                                            </div>	
															<div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="payment-adress">
																...
																<button type="submit" class="btn btn-primary waves-effect waves-light" id="submit" name="submit"  onSubmit="add_fy_student_code.phpy">Submit</button>
																<!--<a class="btn btn-success btn-block loginbtn" href="add_fy_marks.php">Submit</a>-->
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
