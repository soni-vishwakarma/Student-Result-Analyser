                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <form id="add-administrator" action="add_fy_marks_code.php" method="post" class="add-administrator">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
															<!-- Left Section -->
															<table style="border-collapse:separate;border-spacing: 0 15px;" >
																...
																</br></br>Seat no: <b><?php echo $seatno; ?></b>
																</td>
																</tr>		
															</table>						
																<table style="border-collapse:separate; border-spacing: 0 15px;" >
                                                                ...
                                                                <input id="s_id" name="s_id" type="hidden" class="form-control" value="<?php echo $s_id; ?>" placeholder="ID">
																	...
																	<tr>
																		<div class="form-group">
																		   <td><b>Programming in C: </b> </td><td><input id="sub1" name="sub1" type="text" class="form-control" placeholder=""></td>
																		</div>
																	</tr>
																	<tr>
																		<div class="form-group">
																		   <td><b>Programming in C++: </b> </td><td><input id="sub2" name="sub2" type="text" class="form-control" placeholder=""></td>
																		</div>
																	</tr>
																	<tr>
																		<div class="form-group">
																			<td><b>Software Engineering: </b> </td><td><input id="sub3" name="sub3" type="text" class="form-control" placeholder=""></td>
																		</div>
																	</tr>
																	<tr>
																		<div class="form-group">
																			<td><b>Operating System: </b> </td><td><input id="sub4" name="sub4" type="text" class="form-control" placeholder=""></td>
																		</div>
																	</tr>
																	<tr>
																		<div class="form-group">
																			<td><b>Core Java: </b> </td><td><input type="text" id="sub5" name="sub5" class="form-control" placeholder=""></td>
																		</div>
																	</tr>
																</table>
															<!-- Left Section Ends-->
