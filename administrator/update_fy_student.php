                                            ...
                                            <div class="review-content-section">
                                                <form id="add-student" action="update_fy_student_code.php" method="post" class="add-student">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
															<!--<div class="form-group">
                                                                    <input type="textarea" id="s_address" name="s_address" value="" placeholder="Address" >
                                                            </div>-->	
															<div class="form-group">
                                                                    <textarea id="s_address" name="s_address" value="<?php echo $s_address; ?>" style="height:80px;width:360px" ></textarea>
                                                            </div>
															<div class="form-group">
															...
															<div class="form-group">
                                                                <input name="examyear" id="examyear" type="text" class="form-control" value="<?php echo $examyear; ?>" placeholder="Examination Year(2000-2001)">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
