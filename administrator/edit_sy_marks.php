                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="sub1" data-editable="true">Advanced Java</th>
                                                <th data-field="sub2" data-editable="true">Python</th>
                                                <th data-field="sub3" data-editable="true">PHP</th>
                                                <th data-field="sub4" data-editable="true">Software Testing</th>
                                                <th data-field="sub5" data-editable="true">Android</th>
										...
										<?php 					
												...
												$sql = "SELECT sy1_student.s_id,sy1_student.s_name,sy1_student.seatno,sy_marks.s_id,sy_marks.sub1,sy_marks.sub2,sy_marks.sub3,sy_marks.sub4,sy_marks.sub5 FROM sy1_student JOIN sy_marks ON sy1_student.s_id=sy_marks.s_id";
												...
												//$result1 = array();
													...
													//{
														...
														echo $row['sub5'];
														print "</td><td>";
														$temp = "./update_sy_marks.php?s_id=".$row['s_id'];
														...
														$temp = "./delete_sy_marks_code.php?s_id=".$row['s_id'];
