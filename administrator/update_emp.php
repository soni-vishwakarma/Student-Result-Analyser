                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Update Employee</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <div class="form-group">
                                                                <input id="emp_name" name="emp_name" type="text" value="<?php echo $emp_name; ?>" class="form-control" placeholder="Name">
                                                            </div>
                                                            <div class="form-group">
                                                                <input id="emp_mob" name="emp_mob" type="text" class="form-control" value="<?php echo $emp_mob; ?>" placeholder="Contact Number">
                                                            </div>
                                                            <div class="form-group">
                                                                <input id="emp_mail_id" name="emp_mail_id" type="email" class="form-control" value="<?php echo $emp_mail_id; ?>" placeholder="Email">
                                                            </div>
															<!-- Left Section Ends-->
                                                        </div>
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
