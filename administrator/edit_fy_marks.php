                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
										...
										<?php 					
												...
												$sql = "SELECT student.s_id,student.s_name,student.seatno,fy_marks.s_id,fy_marks.sub1,fy_marks.sub2,fy_marks.sub3,fy_marks.sub4,fy_marks.sub5 FROM student JOIN fy_marks ON student.s_id=fy_marks.s_id";
												...
												//$result1 = array();
													...
													//{
														...
														echo $row['sub5'];
														print "</td><td>";
														$temp = "./update_fy_marks.php?s_id=".$row['s_id'];
														...
														$temp = "./delete_fy_marks_code.php?adm_id=".$row['s_id'];
